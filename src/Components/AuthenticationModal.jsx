...
if (!signupFields.phoneNumber) {
  ...
  newErrors.phoneNumber = "Phone number must contain exactly 10 digits.";
          ...
          // function to handle submit button in authentication modal
        //    const handleSubmitInAuthentication =()=>{
        //    if(isRegister){
        //      console.log("Signing up with the provided data...");
      
        //   }else{
        //      console.log("Logging in with the provided data...");
        //   }
        // }
